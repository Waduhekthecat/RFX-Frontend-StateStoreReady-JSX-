...
export const styles = {
    ...
    left: "flex items-center gap-3 min-w-[220px]",
    brandLogo: "h-6 w-auto object-contain",
    ...
    tabBase: "px-3 py-1.5 text-sm rounded-lg transition",
    tabActive: "bg-white/15 text-white",
    tabIdle: "text-white/60 hover:text-white hover:bg-white/10",
    right: "flex items-center gap-3 min-w-[220px] justify-end",
